...
for x in range(0,len(l1)):
    l2.append(0)
df=pd.read_csv(r"C:\Users\sridh\Downloads\Disease-prediction\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv(r"C:\Users\sridh\Downloads\Disease-prediction\Testing.csv")
...
w2 = Label(root, justify=CENTER, text="A Project by Sridhishnee and Sowmya", fg="white", bg="blue")
